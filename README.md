...
| Eigenschaft | Details |
|---|---|
| **Typ** | Schulungs-/Awareness-Tool |
| **Backend** | Node.js, Express |
| **E-Mail** | Nodemailer (v8+) |
| **Zielgruppe** | Mitarbeitende der Argo Aviation GmbH |
| **Zweck** | Security Awareness Training |
...
- **Feedback-System** – Sofortiges Feedback bei richtigen/falschen Entscheidungen
- **E-Mail-Simulation** – Simulierte Phishing-Mails via Nodemailer
...
Die Schulung ist dann unter `http://localhost:3000` erreichbar.
